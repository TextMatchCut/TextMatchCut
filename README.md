go run main.go -text="Web Dev" -width=1920 -height=1080 -duration=2 -fps=4 -font-size=80 -min-lines=5 -max-lines=12 -output="epic.mp4" -blur-type=gaussian -blur-radius=1.5 --dev -sfx shutter.wav
